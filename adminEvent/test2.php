    ...
    <?php
          $reponse =  $bdd->query("SELECT id, nom, date, adresse FROM event");
            while ($donnees = $reponse->fetch()){
               ?>
   <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal' data-address='<?php echo str_replace(" ","+",$donnees['adresse']); ?>'><?php echo $donnees['adresse']; ?></button>
<?php
  }
  ?>
